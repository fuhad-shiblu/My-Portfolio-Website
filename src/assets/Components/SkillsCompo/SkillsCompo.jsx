  ...
  return (
    <>
     <div className="mt-[100px]">
          <h2 className='text-xl md:text-3xl text-center uppercase font-bold mb-5'>my expertise</h2>
          ...
          <div className="flex flex-wrap justify-center items-center gap-5">
            ...
            <div key={items.skills_id} className="flex flex-col justify-center items-center gap-5">
              <div className="w-[100px] md:w-[150px] h-[100px] md:h-[150px] p-3 md:p-5 rounded-xl bg-[#e6e6e6] border-2 border-solid border-[#003161] hover:bg-[#003161] hover:scale-[1.1] hover:rotate-[-10deg] transition-all flex justify-center items-center">
                <img className='w-full h-full hover:scale-[1.1] transition-all' src={items.skills_image} alt={items.skills_alt} />
              </div>
              <p className='uppercase font-medium text-sm md:text-xl'>{items.skills_name}</p>
            </div>
              ))
            }
          </div>
